  ...
  static ThemeData dark() {
    ...
    return ThemeData(
      ...
      colorScheme: ColorScheme(
        ...
        tertiary: SwfColors.blue,
        onTertiary: Colors.white,
        surface: SwfColors.color7,
        onSurface: SwfColors.color8,
        surfaceContainerHighest: SwfColors.color5,
        onSurfaceVariant: SwfColors.lightGray,
        error: const Color(0xFFCF6679),
        onError: Colors.white,
        outline: SwfColors.lightGray,
        shadow: Colors.black26,
      ),
      scaffoldBackgroundColor: SwfColors.color7,
      appBarTheme: AppBarTheme(
        backgroundColor: SwfColors.color2,
        foregroundColor: SwfColors.color8,
        elevation: 0,
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: SwfColors.color8.withAlpha(25),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(8),
        ...
        labelStyle: textTheme.bodyMedium?.copyWith(color: SwfColors.lightGray),
        hintStyle: textTheme.bodyMedium?.copyWith(color: SwfColors.lightGray),
      ),
      dividerTheme: const DividerThemeData(
